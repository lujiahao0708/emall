...
var category = {OBJ: $("#_JD_ALLSORT"),
		//URL_Serv: "http://rest.emall.com/item/category/all?callback=category.getDataService",
		URL_Serv: "http://localhost:8081/rest/item/category/all?callback=category.getDataService",
